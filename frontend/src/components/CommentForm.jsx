...
export function CommentForm({ onSubmit, disabled }) {
  ...
  async function submit(event) {
    ...
    try { await onSubmit(text); setText(''); } catch (error_) { setError(error_); } finally { setBusy(false); }
  }
